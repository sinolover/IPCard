...
Begin VB.Form frmAddMoneyHistory 
   Caption         =   "历史充值信息"
   ClientHeight    =   4995
   ClientLeft      =   1875
   ClientTop       =   2145
   ClientWidth     =   7485
   Icon            =   "frmAddMoneyHistory.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ScaleHeight     =   4995
   ...
   Begin MSDataGridLib.DataGrid dgAddMoney 
      Bindings        =   "frmAddMoneyHistory.frx":29A2
      Height          =   3375
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmAddMoneyHistory"
...
adcAddMoney.RecordSource = "select * from cxAddMoneyHistory"
adcAddMoney.Refresh
