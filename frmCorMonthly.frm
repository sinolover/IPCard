...
Begin VB.Form frmCorMonthly 
   ...
   Begin MSAdodcLib.Adodc adcUsedMoney 
      ...
      UserName        =   "sa"
      Password        =   "iamchinese"
      RecordSource    =   "select * from cxCorMonthly"
      Caption         =   "UsedMoney"
   ...
   Begin MSDataGridLib.DataGrid dgUsedMoney 
      Bindings        =   "frmCorMonthly.frx":0000
      Height          =   1815
      Left            =   0
      TabIndex        =   0
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frmCorMonthly"
...
With colColumns
 .Item("theYear").Width = 10 * 130
 .Item("theYear").Alignment = dbgRight
 .Item("theYear").Caption = "年份"
 .Item("theMonth").Width = 10 * 130
 .Item("theMonth").Alignment = dbgRight
 .Item("theMonth").Caption = "月份"
