...
Private Sub dgCard_Error(ByVal DataError As Integer, Response As Integer)
Response = 0
End Sub
...
'Set Me.dgCard.DataSource = rst
'With rst
'    .PageSize = 60
'    .Open strSql, gCnn, adOpenDynamic, adLockReadOnly
'End With
adcCard.RecordSource = strSql
setADODC Me.adcCard
adcCard.Refresh
