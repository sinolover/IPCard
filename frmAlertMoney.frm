...
Begin VB.Form frmAlertMoney 
   ...
   Begin MSDataGridLib.DataGrid dgCount 
      Bindings        =   "frmAlertMoney.frx":0000
      Height          =   4335
      Left            =   0
      TabIndex        =   0
      Top             =   0
...
RefreshWindows Me.dgCount.Columns
strAlert = GetReg("AlertMoney", "0")
If Not IsNumeric(strAlert) Then strAlert = "0"
strSql = "Select * from cxAlertMoney where trim(WkrName)='" _
         & Trim(strOprName) & "' and AlertMoney - nowMoney >=" & strAlert _
         & " and AlertMoney <> 0 order by alertMoney DESC"
