...
Begin VB.Form frmIPCount 
   ...
   Begin MSAdodcLib.Adodc adcIPCount 
      ...
      UserName        =   "sa"
      Password        =   "iamchinese"
      RecordSource    =   "select * from cxIpCount"
      Caption         =   "IPCount"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "宋体"
         Size            =   9
...
RefreshOther
adcIPCount.RecordSource = strSql
adcIPCount.ConnectionString = "DSN=IPCard"
adcIPCount.Refresh
If Not adcIPCount.Recordset.EOF Then adcIPCount.Recordset.MoveLast
End Sub
Private Sub Form_Resize()
If Me.Width < 100 Then Exit Sub
If Me.Height < 500 Then Exit Sub
dgCount.Width = frmIPCount.Width - 120
dgCount.Height = frmIPCount.Height - 400
End Sub
